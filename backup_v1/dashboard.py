...
# --- CONTROLE DE TEMA (MODO CLARO FIXO) ---
# Define o estilo visual padrão (Branco/Clean) sem opção de troca na sidebar
css_rules = """
    ...
    /* Fundo da aplicação (Branco gelo/Cinza muito claro) */
    .stApp {
        background-color: #f3f4f6;
        color: #1f2937;
    }

    /* CARDS (Branco puro com borda sutil e sombra suave) */
...
# --- 2. FILTROS ---
with st.sidebar :
	# Não há mais header de tema aqui
	st.header("🔍 Filtros")
